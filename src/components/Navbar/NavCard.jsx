...
function CardArtwork({ kind, label }) {
  ...
  if (kind === 'about') return <div className={styles.aboutArtwork} aria-hidden="true"><div className={styles.portrait}><span /><span /><span /></div><p>We have a <em>passion</em><br />for <em>design</em> and<br /><em>strategy.</em></p></div>
